...
describe('arrayStateApi', () => {
  describe('clear', () => {
    test('clears the array state', () => {
      ...
      const { result } = renderHook(() => useArrayStateApi(initialState));
      act(() => {
  ...
  describe('push', () => {
    test('pushes to the end of the array', () => {
      ...
      const { result } = renderHook(() => useArrayStateApi<number>(initialState));
      act(() => {
  ...
  describe('insertAt', () => {
    test('inserts states into an array at index', () => {
      ...
      const { result } = renderHook(() => useArrayStateApi<string>(initialState));
      act(() => {
  ...
  describe('upsertAt', () => {
    test('replaces state of array at index', () => {
      ...
      expect(result.current.state).toEqual(['Banana', 'Grapefruit', 'Nectarine']);
    });
